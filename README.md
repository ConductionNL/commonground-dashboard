...
Description
----
The Common Ground dashboard offers basic management and treatment options for Common Ground components and especially adds a lot of value in the development context, where data in components must be adjusted or viewed for testing purposes.
