...
class MemoController extends AbstractController
{
    ...
    public function memoAction(Request $request, CommonGroundService $commonGroundService, TranslatorInterface $translator, $id)
    {
        ...
        if($id == 'new'){
            ...
            $variables['resource'] = $commonGroundService->getResource(['component'=>'lc','type'=>'memo','id'=> $id]);        }
        ...
        if ($request->isMethod('POST')) {
            ...
            $variables['resource'] = $commonGroundService->saveResource($resource,(['component'=>'memo','type'=>'memo','id'=>$id]));
        }
