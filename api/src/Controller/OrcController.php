...
class OrcController extends AbstractController
{
    ...
    public function ordersAction(CommonGroundService $commonGroundService, TranslatorInterface $translator)
    {
        ...
        $variables['resources'] = $commonGroundService->getResourceList('https://orc.huwelijksplanner.online/orders')["hydra:member"];
    ...
    public function orderAction(Request $request, CommonGroundService $commonGroundService, TranslatorInterface $translator, $id)
    {
        ...
        if($id == 'new'){
            ...
            $variables['resource'] = $commonGroundService->getResource('https://orc.huwelijksplanner.online/orders/'.$id);
        }
        ...
        if ($request->isMethod('POST')) {
            ...
            $variables['resource'] = $commonGroundService->saveResource($resource,'https://orc.huwelijksplanner.online/orders/');
        }
    ...
    public function orderItemsAction(CommonGroundService $commonGroundService, TranslatorInterface $translator)
    {
        ...
        $variables['resources'] = $commonGroundService->getResourceList('https://orc.huwelijksplanner.online/order_items')["hydra:member"];
    ...
    public function orderItemAction(Request $request, CommonGroundService $commonGroundService, TranslatorInterface $translator, $id)
    {
        ...
        if($id == 'new'){
            ...
            $variables['resource'] = $commonGroundService->getResource('https://orc.huwelijksplanner.online/order_items/'.$id);
        }
        ...
        if ($request->isMethod('POST')) {
            ...
            $variables['resource'] = $commonGroundService->saveResource($resource,'https://orc.huwelijksplanner.online/order_items/');
        }
    ...
    public function taxesAction(CommonGroundService $commonGroundService, TranslatorInterface $translator)
    {
        ...
        $variables['resources'] = $commonGroundService->getResourceList('https://orc.huwelijksplanner.online/taxes')["hydra:member"];
    ...
    public function taxAction(Request $request, CommonGroundService $commonGroundService, TranslatorInterface $translator, $id)
    {
        ...
        if($id == 'new'){
            ...
            $variables['resource'] = $commonGroundService->getResource('https://orc.huwelijksplanner.online/taxes/'.$id);
        }
        ...
        if ($request->isMethod('POST')) {
            ...
            $variables['resource'] = $commonGroundService->saveResource($resource,'https://orc.huwelijksplanner.online/taxes/');
        }
    ...
    public function organizationsAction(CommonGroundService $commonGroundService, TranslatorInterface $translator)
    {
        ...
        $variables['resources'] = $commonGroundService->getResourceList('https://orc.huwelijksplanner.online/organizations')["hydra:member"];
    ...
    public function organizationAction(Request $request, CommonGroundService $commonGroundService, TranslatorInterface $translator, $id)
    {
        ...
        if($id == 'new'){
            ...
            $variables['resource'] = $commonGroundService->getResource('https://orc.huwelijksplanner.online/organizations/'.$id);
        }
        ...
        if ($request->isMethod('POST')) {
            ...
            $variables['resource'] = $commonGroundService->saveResource($resource,'https://orc.huwelijksplanner.online/organizations/');
        }
